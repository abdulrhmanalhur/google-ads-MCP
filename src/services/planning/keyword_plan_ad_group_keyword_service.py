...
def register_keyword_plan_ad_group_keyword_tools(mcp: FastMCP[Any]) -> None:
    ...
    @mcp.tool
    async def mutate_kp_ad_group_keywords(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
    ...
    @mcp.tool
    async def create_kp_ad_group_keyword(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        keyword_plan_ad_group: str,
        text: str,
        match_type: str,
    ...
    @mcp.tool
    async def update_kp_ad_group_keyword(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        resource_name: str,
        text: Optional[str] = None,
    ...
    @mcp.tool
    async def remove_kp_ad_group_keyword(  # pyright: ignore[reportUnusedFunction]
        customer_id: str,
        resource_name: str,
    ) -> str:
