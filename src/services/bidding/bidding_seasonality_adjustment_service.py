...
def create_bidding_seasonality_adjustment_tools(
    ...
    async def create_seasonality_adjustment(
        ctx: Context,
        customer_id: str,
        name: str,
        scope: str,
    ...
    async def update_seasonality_adjustment(
        ctx: Context,
        customer_id: str,
        adjustment_resource_name: str,
        name: Optional[str] = None,
    ...
    async def list_seasonality_adjustments(
        ctx: Context,
        customer_id: str,
        scope_filter: Optional[str] = None,
    ) -> List[Dict[str, Any]]:
    ...
    async def remove_seasonality_adjustment(
        ctx: Context,
        customer_id: str,
        adjustment_resource_name: str,
    ) -> Dict[str, Any]:
