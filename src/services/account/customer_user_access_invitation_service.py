...
def create_customer_user_access_invitation_tools(
    ...
    async def create_user_access_invitation(
        ctx: Context,
        customer_id: str,
        email_address: str,
        access_role: str,
    ...
    async def list_user_access_invitations(
        ctx: Context,
        customer_id: str,
        status_filter: Optional[str] = None,
    ) -> List[Dict[str, Any]]:
    ...
    async def remove_user_access_invitation(
        ctx: Context,
        customer_id: str,
        invitation_resource_name: str,
    ) -> Dict[str, Any]:
    ...
    tools.extend(
        [
            create_user_access_invitation,
            list_user_access_invitations,
            remove_user_access_invitation,
        ]
    )
    return tools
